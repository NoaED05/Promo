...
$sql = $sql = 'SELECT RBP.id, RBP.romNummer, CAST(RBP.Temperatur AS DECIMAL(3,1)) AS Temperatur, RBP.dato FROM RBP ORDER BY dato DESC LIMIT 10 ;';
...
echo "</tr>";
// gir tabelen id-er og henter dataen fra databasen
